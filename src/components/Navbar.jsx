    ...
    return (
        <div className='top-0 z-1000 bg-white w-full'>
            <nav className='flex justify-between items-center p-8'>
                <div>
                    <NavLink to='/' className='text-Black text-5xl font-bold'>Online Shop</NavLink>
                </div>
                <div className='flex justify-center items-center gap-4'>
                    ...
                    <NavLink to='/cart' className={({ isActive }) => isActive ? 'btn active cursor-pointer text-lime-400 group' : 'cursor-pointer hover:text-lime-400 transition-all duration-300 group'}>
                        <div className='flex justify-center items-center gap-1'>
                            ...
                            <span className="flex items-center justify-center text-white w-6 h-6 p-4 text-md font-medium rounded-4xl border-2 border-lime-400 bg-lime-400 transition-colors duration-300 group-hover:text-lime-400 group-hover:bg-transparent">
                                {totalQuantity}
                            </span>
                        </div>
                    </NavLink>
