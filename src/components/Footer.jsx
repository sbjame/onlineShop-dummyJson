...
const Footer = () =>{
    return(
        <div className="bg-white flex justify-around p-8">
            <div className="left flex flex-col gap-4">
                <h1 className='font-medium text-2xl'>Store Location</h1>
                <h2>Bangkok, Thailand</h2>
                <h2>surawut.workk@gmail.com</h2>
                <h2>092-629-7525</h2>
                <div className="social flex justify-between items-center gap-6 w-50">
            ...
            <div className="middle flex flex-col flex-wrap gap-4">
                <h1 className='font-medium text-2xl'>Shop</h1>
                <CategoryMenu variant='footer'/>
            </div>
            <div className="right flex flex-col gap-2">
                <h1 className='font-medium text-2xl'>Policy</h1>
