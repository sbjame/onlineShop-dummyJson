...
import AddressToDelivery from '../components/Cart/AddressToDelivery';
import TotalAmout from '../components/Cart/TotalAmount';
...
const Cart = () => {
    ...
    const subTotal = cart.reduce((acc, item) =>{
        const discoutedPrice = ((item.price * (100 - item.discountPercentage)) / 100);
        return acc + discoutedPrice * item.quantity
    }, 0)
    ...
    return (
        <div className='flex flex-col flex-wrap justify-center items-center m-auto p-16 gap-8'>
            ...
            <div className='flex flex-col gap-8 w-[80vw] p-8 bg-gray-100'>
                <TotalAmout
                    subTotal={subTotal}
                />
                <div>
                ...
                <div className='text-center p-4 w-full cursor-pointer rounded-[999px] border-8 border-lime-400 bg-lime-400 hover:bg-transparent hover:drop-shadow-2xl group transition-all duration-300 ease-in-out'>
