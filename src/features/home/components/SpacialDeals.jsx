const SpacialDeal = () => {
    return(
        <div className="flex flex-col lg:flex-row gap-2 md:gap-8">
            <div className="right p-4 md:p-20 bg-[url(/img/redPhone.jpg)] bg-cover bg-center h-150 text-white flex flex-col w-full items-baseline justify-center gap-4">
            ...
            <div className="left p-4 md:p-20 bg-[url(/img/purpleHeadphone.jpg)] bg-cover bg-center h-150 text-white flex flex-col w-full items-baseline justify-center gap-4">
