const SpacialDeal = () => {
    return(
        <div className="flex flex-col lg:flex-row-2 gap-2 md:gap-8">
            <div className="right p-4 md:p-20 bg-[url(./img/redPhone.avif)] bg-cover bg-center h-150 text-white flex flex-col flex-auto items-baseline justify-center gap-4">
            ...
            <div className="left p-4 md:p-20 bg-[url(./img/purpleheadphone.png)] bg-cover bg-center h-150 text-white flex flex-col flex-auto items-baseline justify-center gap-4">
