const ShippingReturn = () => {
    return(
        <div className="flex flex-col justify-center items-center gap-8 m-auto">
            <h1 className="text-3xl md:text-5xl font-medium text-black text-center border-b border-gray-500 p-2 md:p-20 w-[90%]">Shipping & Return</h1>
            <div className="flex flex-col justify-center items-center text-center gap-4 max-w-[90%] md:max-w-[80%] text-black text-xl font-light">
                <h2 className="text-2xl md:text-4xl font-medium text-black">Shipping Policy</h2>
                <p>
            ...
            <div className="flex flex-col justify-center items-center text-center gap-4 max-w-[90%] md:max-w-[80%] text-black text-xl font-light">
                <h2 className="text-2xl md:text-4xl font-medium text-black">Return & Exchange Policy</h2>
                <p>
