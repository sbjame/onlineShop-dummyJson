const TermsConditions = () => {
    return(
        <div className="flex flex-col justify-center items-center gap-16 m-auto">
            <h1 className="text-3xl md:text-5xl font-medium text-black text-center border-b border-gray-500 p-2 md:p-20 w-[90%]">Terms & Conditions</h1>
            <div className="flex flex-col justify-center items-center text-center gap-4 max-w-[90%] md:max-w-[80%] text-black text-xl font-light">
                <h2 className="text-2xl md:text-4xl font-medium text-black">Customer Care</h2>
                <p>
            ...
            <div className="flex flex-col justify-center items-center text-center gap-4 max-w-[90%] md:max-w-[80%] text-black text-xl font-light">
                <h2 className="text-2xl md:text-4xl font-medium text-black">Privacy & Safety</h2>
                <p>
            ...
            <div className="flex flex-col justify-center items-center text-center gap-4 max-w-[90%] md:max-w-[80%] text-black text-xl font-light">
                <h2 className="text-2xl md:text-4xl font-medium text-black">Wholesale Inquiries</h2>
                <p>
            ...
            <div className="flex flex-col justify-center items-center text-center gap-4 max-w-[90%] md:max-w-[80%] text-black text-xl font-light">
                <h2 className="text-2xl md:text-4xl font-medium text-black">Payment Methods</h2>
